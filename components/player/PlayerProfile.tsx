...
export type PlayerProfileProps = ViewProps & { data: PlayerProfile };
  ...
  return (
    <View style={style}>
      ...
      <View style={[styles.uangleLeftParent, styles.containerFlexBox]}>
        {/* <Image
      style={styles.uangleLeftIcon}
      resizeMode="cover"
      source={require("../assets/uangleleft.png")}
    /> */}
        <View style={styles.favorite}>
          <View style={[styles.favoriteChild, styles.favoriteChildPosition]} />
          {/* <Image
        style={[styles.vectorIcon, styles.childFramePosition]}
        resizeMode="cover"
